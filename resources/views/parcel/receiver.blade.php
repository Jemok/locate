...
<div class="col-md-offset-3 col-md-5 register">
    ...
    {!! Form::model($receiver, ['url' => '/parcel/receiver-update/', 'method' => 'POST', 'class' => 'form-horizontal'])!!}
    ...
    {!! csrf_field() !!}
        ...
        <div class="col-md-12">
            <div class="text-center form-group col-md-6">
                <a href="/receiver/back/"><button type="button" class="btn btn-warning">Previous</button></a>
            </div>
    ...
    <form method="POST" action="/parcel/receiver/" class="form-horizontal">
        {!! csrf_field() !!}
