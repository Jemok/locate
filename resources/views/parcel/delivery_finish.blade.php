...
<div class="col-md-offset-3 col-md-5 register">
    ...
    {!! Form::model($delivery, ['url' => '/parcel/delivery-edit-update/'. $parcelId, 'method' => 'POST', 'class' => 'form-horizontal'])!!}
    ...
    {!! csrf_field() !!}
        ...
        <div class="col-md-offset-2">
            <div class="radio">
                <label>
                    <input type="radio" name="deliveryStatus" id="optionsDeliveryStatus1" value="">
                    Deliver to agent
                </label>
            </div>
            <div class="radio">
                <label>
                    <input type="radio" name="deliveryStatus" id="optionsDeliveryStatus2" value="">
            ...
            <div class="form-group {{ $errors->has('parcelDeliveryDate') ? 'has-error' : ''}}">
                {!! Form::text('parcelDeliveryDate', null, ['class' => 'form-control', 'id' => 'dateToPick'])!!}
    ...
    <form method="POST" action="/parcel/delivery-finish/{{ $parcelId }}" class="form-horizontal">
        {!! csrf_field() !!}
